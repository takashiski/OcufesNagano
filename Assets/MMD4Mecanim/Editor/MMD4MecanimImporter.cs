...
public partial class MMD4MecanimImporter : ScriptableObject
{
	...
	public void OnInspectorGUI()
	{
		...
		if( this.pmx2fbxConfig != null ) {
			...
			#if MMD4MECANIM_SAVE_AGREE
			if( !_isAgreedWeak && !this.pmx2fbxConfig.isAgreed )
			#else
			if( !_isAgreedWeak )
			#endif
			{
...

				{
					...
					if( isAgree ) {
						#if MMD4MECANIM_SAVE_AGREE
						switch( _licenseAgree ) {
						default:
							_isAgreedWeak = true;
							break;
						case LicenseAgree.Warning:
							this.pmx2fbxConfig.isAgreed = true;
